...
if (isset($_GET['id'])) {
    ...
    if (isset($_GET['confirm'])) {
        if ($_GET['confirm'] == 'yes') {
            ...
            $stmt->execute([$_GET['id']]);
            $msg = 'You have deleted the informação!';
        } else {
...
<div class="content delete">
    ...
    <p><?=$msg?></p>
    <?php else: ?>
	<p>Are you sure you want to delete language #<?=$informacao['id']?>?</p>
    <div class="yesno">
        <a href="delete.php?id=<?=$informacao['id']?>&confirm=yes">Yes</a>
        <a href="delete.php?id=<?=$informacao['id']?>&confirm=no">No</a>
    </div>
    <?php endif; ?>
</div>
